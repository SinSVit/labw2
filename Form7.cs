...
namespace WindowsFormsApp2
{
    public partial class Form7 : Form
    {
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            Text = String.Format("Лабораторії - {0}", Content.Univer[Content.NumToShow].Name);
            ...
            label2.Text = String.Format("Кількість лабораторій: {0}", Content.Univer[Content.NumToShow].Auditory[0]);
        ...
        {
            Content.Univer[Content.NumToShow].Auditories(true, true);
            label2.Text = String.Format("Кількість лабораторій: {0}", Content.Univer[Content.NumToShow].Auditory[0]);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Content.Univer[Content.NumToShow].Auditories(true, false);
            LabNum--;
            String text = String.Format("Лабораторія №{0}\n", (LabNum + 1));
            int counter = 0;
            for (int i = 0; i < Content.Univer[Content.NumToShow].Engineers.Length; i++)
